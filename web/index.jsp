                ...
                <div class="card-body text-center">
                    <form action="Validar" class="form-sign" method="POST">
                        <div class="form-group">
                            <h3>INICIO</h3>
                            <img src="https://logowik.com/content/uploads/images/universidad-distrital-francisco-jose-de-caldas2258.logowik.com.webp" alt="Logo" width="300" class="img-fluid" />
